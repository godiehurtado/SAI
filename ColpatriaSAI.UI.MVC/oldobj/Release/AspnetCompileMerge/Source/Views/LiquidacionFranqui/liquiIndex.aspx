...
<table id="tablaLista">
 <thead>
    <tr>
        ...
        <th>Fecha inicio (dd/mm/aaaa) </th>
        <th>Fecha fin (dd/mm/aaaa)</th>
...
<% 
    ...
    <tr>
        ...
        <td>
            <%=item.periodoLiquidacionIni.Value.ToShortDateString()%>
        </td>
        <td>
            <%=item.periodoLiquidacionFin.Value.ToShortDateString()%>
        </td>
		<td align="center">
