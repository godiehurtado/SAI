...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Condiciones del Premio - Sistema de Administración de Incentivos
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var variable = $('#seleccionVariable1');
    ...
    <fieldset>
        <table id="tablaAdmin" width="100%" cellpadding="2">
            <% using (Html.BeginForm("Crear", "CondicionxPremioSubRegla", FormMethod.Post, new { id = "formCondicion" }))
               {
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" id="premiosubregla_id" name="premiosubregla_id" value="<%: ViewData["valueps"] %>" />
                    </td>
                    <td>
    ...
    <table align="center">
        <tr>
            <td>
                <a href="<%= Url.Action("Index", "PremioxSubRegla", new { valuesr = Request.QueryString["valuesr"], valuer = Request.QueryString["valuer"], value = Request.QueryString["value"] }) %>"
    ...
    <table id="tablaLista">
        ...
        <tbody>
            <% foreach (var item in ((IEnumerable<CondicionxPremioSubregla>)ViewData["CondicionesPremio"]))
               { %>
            <tr>
                <td align="center">
                    <a href="javascript:mostrarDialog('<%: ruta %>Editar/<%: item.id %>?idps=<%: item.premioxsubregla_id %>?r=<%: num %>&concurso_id=<%: ViewData["value"] %>&subregla_id=<%: ViewData["valuesr"] %>', 'Editar Condicion', 'dialogEditar');"
