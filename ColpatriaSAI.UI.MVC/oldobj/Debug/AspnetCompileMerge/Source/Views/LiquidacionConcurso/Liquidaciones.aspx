...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% foreach (var item in Model) { %>
        <tr>            
            ...
            <% if (Convert.ToInt16(TempData["tipoConcurso_id"]) == 2) { %><td align="center"><a href='#' onclick="('ReporteLiquidacionConcursoxNodo','idLiquidacion=<%: item.id %>');" title='Descargar Detalle Liquidación'><span class='ui-icon ui-icon-document-b'></span></a></td><% } %>  --%>
