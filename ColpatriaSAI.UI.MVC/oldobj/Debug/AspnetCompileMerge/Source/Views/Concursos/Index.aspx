        ...
        <tr valign="top">
            ...
            <div><input type="checkbox" id="checkBusqueda" onclick="mostrarBusqueda();" /> <label for="checkBusqueda">Avanzada</label></div>
                ...
                <%  
                    ...
                    // Se deben eliminar la palabra Index, causa raiz del error.  CAAM 17.05.2019
                    if (ruta.EndsWith("x")) { ruta = "http"+ ruta.Substring(4, ruta.Length - 10).Trim(); }
                    else { ruta = "http"+ ruta.Substring(4, ruta.Length-4).Trim(); } 
