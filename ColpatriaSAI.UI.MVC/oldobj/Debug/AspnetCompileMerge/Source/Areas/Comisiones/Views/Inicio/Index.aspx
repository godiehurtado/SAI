...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="cuadroAdministracion">
        ...
        <div class="seccion">
            ...
            <ul>
            <li>
                    <%: Html.ActionLink("Reporte detalle de beneficiarios", "ReporteDetalleBeneficiario", "Reportes")%></li>
                <li>
                    <%: Html.ActionLink("Resumen de beneficiarios para cálculo de comisión variable", "ReportesBeneficiario", "Reportes")%></li>
                <%--<li>
                    <%: Html.ActionLink("Reporte Transferencias", "ReporteTransferencias", "Reportes")%></li>--%>
                <li>
                  ...
                  <%--   <li>
                    <%: Html.ActionLink("Reporte Lider Comercial", "ReporteComercial", "Reportes")%></li>--%>
                    <%
