...
-- =============================================
CREATE FUNCTION [dbo].[ObtenerEscalaCumplimientoModelo]
(
...
RETURNS @Escala TABLE (factorInf int, notaInf int, factorSup int, notaSup int)
AS
BEGIN

	DECLARE @factorxnota_id int = @factorxnota_id_param
	DECLARE @nota float = @nota_param
