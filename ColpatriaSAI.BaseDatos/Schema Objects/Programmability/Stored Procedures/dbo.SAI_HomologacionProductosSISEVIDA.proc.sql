...
-- Description:	Homologación del archivo de Productos de VIDA. Se toma la información por columnas (concepto) y se
--			    inserta en la tabla respectiva.
-- =============================================
CREATE PROCEDURE [dbo].[SAI_HomologacionProductosSISEVIDA]
AS
BEGIN
	-- *********************************************************************************************************
	...
	WHERE s.Cod_Ramo <> ''
		...
		AND s.Cod_Compania = '2'
		AND s.Compania = 'SISE VIDA'
		AND NOT EXISTS (
			SELECT *
