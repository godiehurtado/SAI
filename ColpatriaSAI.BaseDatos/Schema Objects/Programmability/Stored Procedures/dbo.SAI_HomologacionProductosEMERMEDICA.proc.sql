...
-- Description:	Homologación del archivo de Productos de EMERMERDICA. Se toma la información por columnas (concepto) y se
--			    inserta en la tabla respectiva.
-- =============================================
CREATE PROCEDURE [dbo].[SAI_HomologacionProductosEMERMEDICA]
AS
BEGIN
	-- *********************************************************************************************************
